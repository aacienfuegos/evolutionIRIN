...
double CBlueLightSensor::m_fLightSensorDir[NUM_LIGHT_SENSORS] 	= {0.2967, 0.8727, 1.5708, 2.6180, 3.6652, 4.7124, 5.4105, 5.9865};
unsigned int CBlueLightSensor::SENSOR_NUMBER = NUM_LIGHT_SENSORS;

/******************************************************************************/
/******************************************************************************/

CBlueLightSensor::CBlueLightSensor(const char* pch_name, double f_rangeLightSensor) :
...
CBlueLightSensor::~CBlueLightSensor()
{
}
...
double* CBlueLightSensor::ComputeSensorReadings(CEpuck* pc_epuck, CSimulator* pc_simulator){
  ...
  CArena* pcArena = pc_simulator->GetArena();
	...
	double fDistance;
	if ( pcArena->GetNearestBlueLight(vPosition, m_fRangeLightSensor, &vLightPosition, &fDistance))
	{
...
unsigned int CBlueLightSensor::GetType(){
	return SENSOR_BLUE_LIGHT;
}

/******************************************************************************/
/******************************************************************************/

double* CBlueLightSensor::GetSensorReading( CEpuck *p_pcEpuck){
...
double CBlueLightSensor::GetMaxRange ( void ) 
{
...
const double* CBlueLightSensor::GetSensorDirections()
{
...
/******************************************************************************/
/******************************************************************************/
void CBlueLightSensor::SwitchNearestLight ( int n_value )
{
	dVector2 vPosition;
...
/******************************************************************************/
/******************************************************************************/
void CBlueLightSensor::PickUpNearestLight ( void )
{
	double 
	dVector2 vPosition;
	vPosition.x = (m_pcEpuck->GetPosition()).x; 
	...
	m_pcArena->SwitchNearestBlueLight(vPosition, 0);
}
