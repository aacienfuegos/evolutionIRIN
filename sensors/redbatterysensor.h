#ifndef REDBATTERYSENSOR_H_
#define REDBATTERYSENSOR_H_
...
#define NUM_RED_BATTERY_SENSORS 1
...
{
public:
    CRedBatterySensor(const char* pch_name, double f_range, double f_charge_coef, double f_discharge_coef);
    ~CRedBatterySensor();
