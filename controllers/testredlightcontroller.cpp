...
CTestRedLightController::CTestRedLightController (const char* pch_name, CEpuck* pc_epuck) : CController (pch_name, pc_epuck)
...
CTestRedLightController::~CTestRedLightController()
{
}
...
void CTestRedLightController::SimulationStep(unsigned n_step_number, double f_time, double f_step_interval)
{
