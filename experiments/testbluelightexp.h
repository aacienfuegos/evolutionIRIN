#ifndef TESTBLUELIGHTEXP_H
#define TESTBLUELIGHTEXP_H
...
class CTestBlueLightExp : public CExperiment
{
public:
    CTestBlueLightExp(const char* pch_name, const char* paramsFile);
