...
/*Create Arena */
const static char *pchHeightMap =
	//"%%%%%%%%%%%%%%%%%%%%"
	//"%############%#####%"
	//"%############%#####%"
	//"%##%%%%%%%%##%##%##%"
...
///*******************************************************************************/
//
CIri1Exp::CIri1Exp(const char *pch_name, const char *paramsFile) : CExperiment(pch_name, COLLISION_MODEL_SIMPLE, COLLISION_HANDLER_POSITION)
{
