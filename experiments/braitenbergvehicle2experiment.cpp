...
///*******************************************************************************/
//
CBraitenbergVehicle2Experiment::CBraitenbergVehicle2Experiment(const char* pch_name, const char* paramsFile) :
...
CBraitenbergVehicle2Experiment::~CBraitenbergVehicle2Experiment ( void )
{
	...
	/******************************************************************************/
/******************************************************************************/
CArena* CBraitenbergVehicle2Experiment::CreateArena()
{
...
void CBraitenbergVehicle2Experiment::AddActuators(CEpuck* pc_epuck)
{
...
void CBraitenbergVehicle2Experiment::AddSensors(CEpuck* pc_epuck)
{
	//
...
void CBraitenbergVehicle2Experiment::SetController(CEpuck* pc_epuck)
{
	char pchTemp[128];
	sprintf(pchTemp, "Iri1");
	CController* pcController = new CBraitenbergVehicle2Controller(pchTemp, pc_epuck, m_nWriteToFile);
	pc_epuck->SetControllerType( CONTROLLER_BRAITENBERG_VEHICLE2 );
...
void CBraitenbergVehicle2Experiment::CreateAndAddEpucks(CSimulator* pc_simulator)
{
...
void CBraitenbergVehicle2Experiment::Reset ( void )
{
}
