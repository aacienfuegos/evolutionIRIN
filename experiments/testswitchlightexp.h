#ifndef TESTSWITCHLIGHTEXP_H
#define TESTSWITCHLIGHTEXP_H
...
class CTestSwitchLightExp : public CExperiment
{
public:
    CTestSwitchLightExp(const char* pch_name, const char* paramsFile);
